...
export default function CompanyHome() {
  ...
  const collections = [
    ...
    },
    {
      ...
      tagColor: '#111',
      tagTextColor: '#fff',
      image: 'https://via.placeholder.com/300x160/8b4513/ffffff?text=LouisVuitton',
    },
    {
      id: '6',
      status: 'Expired',
  ...
  function CollectionCard({ collection }) {
    return (
      <TouchableOpacity style={styles.card} activeOpacity={0.9}>
        <Image source={{ uri: collection.image }} style={styles.cardImage} resizeMode="cover" />
        <View style={styles.cardLabel}>
          <Text style={styles.brand}>{collection.brand}</Text>
          <Text style={[styles.tag, { backgroundColor: collection.tagColor, color: collection.tagTextColor }]}>
            {collection.tag}
          </Text>
        </View>
    ...
    return (
      <View style={styles.accordionContainer}>
        ...
        >
          ...
          {icon}
          <Ionicons name={open ? 'chevron-up' : 'chevron-down'} size={24} color="#fff" style={{ marginLeft: 8 }} />
        </TouchableOpacity>
        {open && (
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tabs}>
          ...
          >
            <Text style={[styles.tabText, activeTab === 'Draft' && styles.activeText]}>Draft</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.tabButton, activeTab === 'Listed' && styles.activeTab]}
            onPress={() => setActiveTab('Listed')}
          >
            <Text style={[styles.tabText, activeTab === 'Listed' && styles.activeText]}>Listed</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.tabButton, activeTab === 'Expired' && styles.activeTab]}
            onPress={() => setActiveTab('Expired')}
          >
            <Text style={[styles.tabText, activeTab === 'Expired' && styles.activeText]}>Expired</Text>
          </TouchableOpacity>
        </View>
      ...
      <TouchableOpacity style={styles.newCollectionButton} onPress={() => router.push('/(company)/new-collection')}>
