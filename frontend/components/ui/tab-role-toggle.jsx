...
export default function TabRoleToggle() {
  ...
  const userImage =
    "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/XFzS8cy7qn/4csdcmha_expires_30_days.png";
  const companyImage =
    "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/XFzS8cy7qn/zljzv37i_expires_30_days.png";
