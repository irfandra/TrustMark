// components/BrandCategoryFilterDrawer.jsx
...
export default function BrandCategoryFilterDrawer({ visible, onClose, onApply, selected }) {
  ...
  // ✅ Fixed — only check explicitly selected items
        ...
        >
          ...
          <ScrollView style={styles.drawerScroll} showsVerticalScrollIndicator={false}>
            ...
            {BRAND_CATEGORIES.map((cat) => {
              const active = isSelected(cat.label);
              return (
                <TouchableOpacity
                  key={cat.id}
