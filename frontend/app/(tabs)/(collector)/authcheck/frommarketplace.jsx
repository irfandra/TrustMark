// app/(tabs)/(collector)/authcheck/frommarketplace.jsx
...
export default function FromMarketplacePage() {
  ...
  // ✅ Card width for CatalogItemCard
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {/* ✅ Step 3 — ItemDetailCard (showStatus=false — no rack badge) */}
        {step === 3 && (
          <View style={styles.grid}>
...
const styles = StyleSheet.create({
  ...
  // ✅ CollectionCard wrapper — match grid width
