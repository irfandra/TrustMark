// app/(tabs)/(collector)/marketplace/collection/product/checkout.jsx
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.transactionTable}>
            <TransactionRow label="Current Owner"       value={MOCK_TRANSACTION.currentOwner} />
            <TransactionRow label={`Blockchain\nContract`} value={MOCK_TRANSACTION.contract} />
            <TransactionRow label="From"                value={MOCK_TRANSACTION.from} />
            <TransactionRow label="To"                  value={MOCK_TRANSACTION.to} />
          </View>
      ...
      >
        <View style={styles.bottomBarLeft}>
          ...
          <Text style={styles.bottomBarSub}>({itemId})</Text>
        </View>
