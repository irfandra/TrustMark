// app/(tabs)/item/[itemId]/scanner.jsx
...
export default function ScannerPage() {
  ...
  const handleBarCodeScanned = ({ data }) => {
    ...
    // ✅ Pass back the scan result and type to claimownership
    router.back();
    // Use a small timeout to ensure back navigation completes
    setTimeout(() => {
      router.setParams({ [`${type}Scanned`]: 'true' });
    }, 100);
  };
